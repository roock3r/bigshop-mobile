...
import 'package:bigshop/provider/about_app/about_app_provider.dart';
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child: Text(data.aboutEmail,
                        style: Theme.of(context).textTheme.bodyText1),
                    onTap: () async {
                      if (await canLaunch('mailto:csilva@silvatech.org')) {
                        await launch('mailto:csilva@silvatech.org');
                      } else {
                        throw 'Could not launch csilva@silvatech.org';
                      }
                    },
                  ),
                ],
