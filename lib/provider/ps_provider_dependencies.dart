import 'package:bigshop/db/about_app_dao.dart';
import 'package:bigshop/db/shipping_area_dao.dart';
import 'package:bigshop/db/shop_dao.dart';
import 'package:bigshop/db/shop_map_dao.dart';
import 'package:bigshop/db/shop_rating_dao.dart';
import 'package:bigshop/db/transaction_status_dao.dart';
import 'package:bigshop/repository/about_app_repository.dart';
import 'package:bigshop/repository/delete_task_repository.dart';
import 'package:bigshop/repository/shipping_area_repository.dart';
import 'package:bigshop/db/basket_dao.dart';
import 'package:bigshop/db/category_map_dao.dart';
import 'package:bigshop/db/comment_detail_dao.dart';
import 'package:bigshop/db/comment_header_dao.dart';
import 'package:bigshop/db/favourite_product_dao.dart';
import 'package:bigshop/db/gallery_dao.dart';
import 'package:bigshop/db/history_dao.dart';
import 'package:bigshop/db/product_collection_header_dao.dart';
import 'package:bigshop/db/rating_dao.dart';
import 'package:bigshop/db/user_dao.dart';
import 'package:bigshop/db/user_login_dao.dart';
import 'package:bigshop/repository/Common/notification_repository.dart';
import 'package:bigshop/repository/basket_repository.dart';
import 'package:bigshop/repository/clear_all_data_repository.dart';
import 'package:bigshop/repository/comment_detail_repository.dart';
import 'package:bigshop/repository/comment_header_repository.dart';
import 'package:bigshop/repository/contact_us_repository.dart';
import 'package:bigshop/repository/coupon_discount_repository.dart';
import 'package:bigshop/repository/gallery_repository.dart';
...
import 'package:bigshop/db/blog_dao.dart';
import 'package:bigshop/db/shop_info_dao.dart';
import 'package:bigshop/db/transaction_detail_dao.dart';
import 'package:bigshop/db/transaction_header_dao.dart';
import 'package:bigshop/repository/blog_repository.dart';
import 'package:bigshop/repository/rating_repository.dart';
import 'package:bigshop/repository/shop_info_repository.dart';
import 'package:bigshop/repository/shop_rating_repository.dart';
import 'package:bigshop/repository/shop_repository.dart';
import 'package:bigshop/repository/tansaction_detail_repository.dart';
import 'package:bigshop/repository/token_repository.dart';
import 'package:bigshop/repository/transaction_header_repository.dart';
import 'package:bigshop/repository/transaction_status_repository.dart';
...
import 'package:bigshop/db/cateogry_dao.dart';
import 'package:bigshop/db/common/ps_shared_preferences.dart';
import 'package:bigshop/db/noti_dao.dart';
import 'package:bigshop/db/sub_category_dao.dart';
import 'package:bigshop/db/product_dao.dart';
import 'package:bigshop/db/product_map_dao.dart';
import 'package:bigshop/repository/app_info_repository.dart';
import 'package:bigshop/repository/category_repository.dart';
import 'package:bigshop/repository/language_repository.dart';
import 'package:bigshop/repository/noti_repository.dart';
import 'package:bigshop/repository/product_repository.dart';
import 'package:bigshop/repository/ps_theme_repository.dart';
